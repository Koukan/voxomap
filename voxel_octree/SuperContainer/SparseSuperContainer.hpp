...
struct SparseSuperContainer
{
	...
	using iterator = supercontainer_iterator<SparseSuperContainer<Container>>;
    ...
    */
	SparseSuperContainer(SparseSuperContainer const& other);
    /*!
    ...
    */
    void                init(VoxelNode<SparseSuperContainer<Container>> const&) {}
    /*!
...
private:
	...
	std::vector<uint16_t>					_free_containers;
    uint16_t	_container_array[NB_CONTAINERS][NB_CONTAINERS][NB_CONTAINERS];  //!< Array of voxel containers
