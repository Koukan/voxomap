...
FaceVoxel<T_Voxel>::FaceVoxel(Args&&... args) : T_Voxel(std::forward<Args>(args)...)
{
}

template <class T_Voxel>
template <typename... Args>
FaceVoxel<T_Voxel>::FaceVoxel(FaceEnum face, Args&&... args) : _voxel_face(face), T_Voxel(std::forward<Args>(args)...)
{
}
